...
test_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='/kitti_data/KittiData/mvxnet_04_seq_pkl/kitti_infos_test.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        data_prefix=dict(
...
train_dataloader = dict(
    ...
    dataset=dict(
        dataset=dict(
            ann_file='/kitti_data/KittiData/info_pkl/kitti_infos_train.pkl',
            backend_args=None,
            box_type_3d='LiDAR',
            data_prefix=dict(
                img='training/image_2', pts='training/velodyne_reduced'),
...
val_dataloader = dict(
    batch_size=1,
    dataset=dict(
        ann_file='/kitti_data/KittiData/info_pkl/kitti_infos_val.pkl',
        backend_args=None,
        box_type_3d='LiDAR',
        data_prefix=dict(
            img='training/image_2', pts='training/velodyne_reduced'),
